...
| 개인 아키텍처 취향 사전을 시스템에 적용 | `apply-architecture-playbook` | [개인 아키텍처 취향 적용하기](skills/apply-architecture-playbook.md) |
...
- `apply-architecture-playbook`은 사용자가 이름을 직접 불렀을 때만 개인 stack·topology 취향을 적용합니다. 취향은 프로젝트 제약과 관측 증거보다 아래에 두며, module interface와 seam은 `codebase-design`에 넘깁니다.
...
- [Architecting and building medium-sized web services in Rust with Axum, SQLx and PostgreSQL](research/RusandPostgreSQL.md) — active; source: Kerkour
- [PostgreSQL-native durable workflow research](research/RusandPostgreSQLv2.md) — active; source: Microsoft `pg_durable`
