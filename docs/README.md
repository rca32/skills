...
```text
first-principles? → prepare-issue → domain-modeling? → codebase-design? → to-spec → to-tickets → work-github-issue
                                                                               ↳ 분해 불가: domain-modeling?/codebase-design?/to-spec 후 재시작
                                                                                                               ├─ diagnosing-bugs
