...
> `rca32/skills` 저장소에서 `work-github-issue`, `triage`, `codebase-design`, `to-spec`, `to-tickets`, `documenting-work`, `diagnosing-bugs`, `complexity-optimizer`, `tdd`, `code-review`, `writing-great-skills` 스킬을 설치해 줘.
